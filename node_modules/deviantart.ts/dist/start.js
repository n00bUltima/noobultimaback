...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var deviantArt, result, result2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, deviantart_1["default"].login(process.env.DEVIANTART_CLIENT_ID, process.env.DEVIANTART_CLIENT_SECRET)
            ...
            case 1:
                deviantArt = _a.sent();
                return [4 /*yield*/, deviantArt.collections.get({ folderid: "79216EF7-CED7-6973-DD90-6793348AD2A4", username: "fhilippe124" })
                    // const result = await deviantArt.rss.get("Eromanga Sensei")
                ];
            case 2:
                result = _a.sent();
                return [4 /*yield*/, deviantArt.extendDeviations(result.results)];
            case 3:
                result2 = _a.sent();
                console.log(result2);
                return [2 /*return*/];
